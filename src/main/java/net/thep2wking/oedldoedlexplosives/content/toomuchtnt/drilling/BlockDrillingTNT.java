...
public class BlockDrillingTNT extends ModBlockTNTBase {
	public BlockDrillingTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityDrillingTNT(world, x, y, z, ignitor);
	}
}