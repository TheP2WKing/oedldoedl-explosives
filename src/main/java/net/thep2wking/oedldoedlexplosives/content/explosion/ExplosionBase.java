...
public class ExplosionBase extends Explosion {
	...
	public ExplosionBase(World worldIn, Entity entityIn, double x, double y, double z, float size,
			List<BlockPos> affectedPositions) {
		this(worldIn, entityIn, x, y, z, size, false, true, affectedPositions);
	}

	public ExplosionBase(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean causesFire,
	...
	public ExplosionBase(World worldIn, Entity entityIn, double x, double y, double z, float size, boolean flaming,
	...
	public ExplosionBase newExplosion(World world, @Nullable Entity entityIn, double x, double y, double z,
			float strength, boolean isFlaming, boolean isSmoking) {
		ExplosionBase explosion = createExplosion(world, entityIn, x, y, z, strength, isFlaming, isSmoking);
	...
	public ExplosionBase createExplosion(World world, @Nullable Entity entityIn, double x, double y, double z, float strength, boolean isFlaming, boolean isSmoking) {
		return new ExplosionBase(world, entityIn, x, y, z, strength, isFlaming, isSmoking);
	}
}