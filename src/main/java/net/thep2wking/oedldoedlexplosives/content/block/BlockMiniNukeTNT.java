...
public class BlockMiniNukeTNT extends ModBlockTNTBase {
	public BlockMiniNukeTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityMiniNukeTNT(world, x, y, z, ignitor, 80, 30.0f, true, true);
	}
}