...
public class ExplosionIncenditary extends ModExplosionBase {
	public ExplosionIncenditary(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
