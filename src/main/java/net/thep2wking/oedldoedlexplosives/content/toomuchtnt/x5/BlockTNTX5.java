...
public class BlockTNTX5 extends ModBlockTNTBase {
	public BlockTNTX5(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityTNTX5(world, x, y, z, ignitor);
	}
}