...
public class BlockMultiplyTNT extends ModBlockTNTBase {
	public BlockMultiplyTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityMultiplyTNT(world, x, y, z, ignitor, 80, 6.0f, false, true);
	}
}