...
public class BlockBrownMushroomTNT extends ModBlockTNTBase {
	public BlockBrownMushroomTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityBrownMushroomTNT(world, x, y, z, ignitor);
	}
}