...
public class BlockMelonTNT extends ModBlockTNTBase {
	public BlockMelonTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityMelonTNT(world, x, y, z, ignitor);
	}
}