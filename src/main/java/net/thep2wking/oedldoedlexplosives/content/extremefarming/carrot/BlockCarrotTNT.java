...
public class BlockCarrotTNT extends ModBlockTNTBase {
	public BlockCarrotTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityCarrotTNT(world, x, y, z, ignitor);
	}
}