...
public class EntityGravelFirework extends ModEntityTNTBase {
	...
	public EntityGravelFirework(World world) {
		super(world);
		this.setFuse(20);
	}
	...
	public ModExplosionBase createTNTExplosion(double x, double y, double z) {
		return new ExplosionGravelFirework(world, ignitor, x, y, z, 8.0f, false, false, false, 0);
	}
