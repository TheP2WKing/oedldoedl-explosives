...
public class BlockDerpyTNT extends ModBlockTNTBase {
	public BlockDerpyTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityDerpyTNT(world, x, y, z, ignitor);
	}
}