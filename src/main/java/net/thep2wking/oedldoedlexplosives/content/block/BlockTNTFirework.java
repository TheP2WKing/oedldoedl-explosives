...
public class BlockTNTFirework extends ModBlockTNTBase {
	public BlockTNTFirework(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityTNTFirework(world, x, y, z, ignitor, 20, 8.0f, false, false);
	}
