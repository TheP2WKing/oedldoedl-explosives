...
public class ExplosionLava extends ModExplosionBase {
	public ExplosionLava(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
		...
		if (this.spawnFire) {
			for (BlockPos blockpos1 : this.affectedBlockPositions) {
				...
				if (this.world.getBlockState(blockpos1).getMaterial() == Material.AIR
					...
					this.world.setBlockState(blockpos1, Blocks.LAVA.getDefaultState(), 3);
				}
			}
		}
	}
