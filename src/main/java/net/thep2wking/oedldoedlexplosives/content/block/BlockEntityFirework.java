...
public class BlockEntityFirework extends ModBlockTNTBase {
	public BlockEntityFirework(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityEntityFirework(world, x, y, z, ignitor, 20, 0.0f, false, false);
	}
