...
public class BlockWheatTNT extends ModBlockTNTBase {
	public BlockWheatTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityWheatTNT(world, x, y, z, ignitor);
	}
}