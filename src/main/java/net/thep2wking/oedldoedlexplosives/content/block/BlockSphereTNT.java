...
public class BlockSphereTNT extends ModBlockTNTBase {
	public BlockSphereTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntitySphereTNT(world, x, y, z, ignitor);
	}
}