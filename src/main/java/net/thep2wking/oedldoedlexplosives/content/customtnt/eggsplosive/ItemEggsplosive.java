...
public class ItemEggsplosive extends ModItemDynamiteBase {
	public ItemEggsplosive(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
