...
public class ItemDynamiteX5 extends ModItemDynamiteBase {
	public ItemDynamiteX5(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
