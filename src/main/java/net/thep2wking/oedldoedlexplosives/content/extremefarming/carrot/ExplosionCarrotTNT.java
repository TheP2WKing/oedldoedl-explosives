...
public class ExplosionCarrotTNT extends ModExplosionBase {
	public ExplosionCarrotTNT(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
        ...
        if (this.spawnFire) {
            for (BlockPos blockpos1 : this.affectedBlockPositions) {
                ...
                if ((blockState.getMaterial() == Material.AIR
                    ...
                    this.placeRandomCarrot(blockpos1);
                }
            }
        }
    }

    public void placeRandomCarrot(BlockPos blockpos) {
        int randomAge = new Random().nextInt(4);
        IBlockState plant = Blocks.CARROTS.getDefaultState().withProperty(BlockCrops.AGE, randomAge);
