...
public class BlockTNTX500 extends ModBlockTNTBase {
	public BlockTNTX500(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityTNTX500(world, x, y, z, ignitor);
	}
}