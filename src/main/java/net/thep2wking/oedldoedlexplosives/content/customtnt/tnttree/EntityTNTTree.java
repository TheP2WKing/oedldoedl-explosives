...
public class EntityTNTTree extends ModEntityTNTBase {
	public EntityTNTTree(World world, double x, double y, double z, EntityLivingBase igniter, int fuse,
	...
	public ModExplosionBase createTNTExplosion(double x, double y, double z) {
		return new ExplosionTNTTree(world, ignitor, x, y, z, 0.0f, false, false, false, 0);
	}
}