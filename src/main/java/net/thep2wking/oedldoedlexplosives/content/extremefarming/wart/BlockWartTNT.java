...
public class BlockWartTNT extends ModBlockTNTBase {
	public BlockWartTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityWartTNT(world, x, y, z, ignitor);
	}
}