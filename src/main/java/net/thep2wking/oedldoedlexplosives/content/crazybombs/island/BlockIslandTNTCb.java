...
public class BlockIslandTNTCb extends ModBlockTNTBase {
	public BlockIslandTNTCb(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityIslandTNTCb(world, x, y, z, ignitor);
	}
}