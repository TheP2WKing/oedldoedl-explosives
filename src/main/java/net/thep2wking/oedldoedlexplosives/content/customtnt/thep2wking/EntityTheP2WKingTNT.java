...
public class EntityTheP2WKingTNT extends ModEntityTNTBase {
	public EntityTheP2WKingTNT(World world, double x, double y, double z, EntityLivingBase igniter, int fuse,
	...
	public ModExplosionBase createTNTExplosion(double x, double y, double z) {
		return new ExplosionTheP2WKingTNT(world, ignitor, x, y, z, 0.0f, true, false, false, 0);
	}
}