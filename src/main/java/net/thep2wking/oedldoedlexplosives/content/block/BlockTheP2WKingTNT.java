...
public class BlockTheP2WKingTNT extends ModBlockTNTBase {
	public BlockTheP2WKingTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityTheP2WKingTNT(world, x, y, z, ignitor);
	}
}