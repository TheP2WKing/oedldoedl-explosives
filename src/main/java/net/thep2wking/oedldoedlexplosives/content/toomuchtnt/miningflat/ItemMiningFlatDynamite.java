...
public class ItemMiningFlatDynamite extends ModItemDynamiteBase {
	public ItemMiningFlatDynamite(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
	...
	public ModEntityDynamiteBase createDynamiteEntity(World world) {
		return new EntityMiningFlatDynamite(world);
	}

	@Override
	public ModEntityDynamiteBase createDynamiteEntity(World world, EntityLivingBase entity) {
		return new EntityMiningFlatDynamite(world, entity);
	}
}