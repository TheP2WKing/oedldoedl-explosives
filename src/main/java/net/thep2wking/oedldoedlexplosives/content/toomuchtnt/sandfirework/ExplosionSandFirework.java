...
public class ExplosionSandFirework extends ModExplosionBase {
	public ExplosionSandFirework(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
