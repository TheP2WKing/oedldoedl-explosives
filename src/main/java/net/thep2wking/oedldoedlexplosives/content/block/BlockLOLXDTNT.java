...
public class BlockLOLXDTNT extends ModBlockTNTBase {
	public BlockLOLXDTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
