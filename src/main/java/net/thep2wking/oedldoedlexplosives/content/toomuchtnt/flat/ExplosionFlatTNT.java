...
public class ExplosionFlatTNT extends ModExplosionBase {
	public ExplosionFlatTNT(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
