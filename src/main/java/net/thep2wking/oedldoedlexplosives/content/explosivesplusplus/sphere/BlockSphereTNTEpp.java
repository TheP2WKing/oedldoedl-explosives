...
public class BlockSphereTNTEpp extends ModBlockTNTBase {
	public BlockSphereTNTEpp(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntitySphereTNTEpp(world, x, y, z, ignitor);
	}
}