...
public class ExplosionWheatTNT extends ModExplosionBase {
	public ExplosionWheatTNT(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
        ...
        if (this.spawnFire) {
            for (BlockPos blockpos1 : this.affectedBlockPositions) {
                ...
                if ((blockState.getMaterial() == Material.AIR
                    ...
                    this.placeRandomWheat(blockpos1);
                }
            }
        }
    }

    public void placeRandomWheat(BlockPos blockpos) {
        int randomAge = new Random().nextInt(8);
        IBlockState plant = Blocks.WHEAT.getDefaultState().withProperty(BlockCrops.AGE, randomAge);
