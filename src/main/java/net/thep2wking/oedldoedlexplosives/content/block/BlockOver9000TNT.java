...
public class BlockOver9000TNT extends ModBlockTNTBase {
	public BlockOver9000TNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityOver9000TNT(world, x, y, z, ignitor);
	}
}