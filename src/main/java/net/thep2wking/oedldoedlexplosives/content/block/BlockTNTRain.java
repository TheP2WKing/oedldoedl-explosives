...
public class BlockTNTRain extends ModBlockTNTBase {
	public BlockTNTRain(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityTNTRain(world, x, y, z, ignitor);
	}
}