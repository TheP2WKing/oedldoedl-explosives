...
public class BlockPumpkinTNT extends ModBlockTNTBase {
	public BlockPumpkinTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityPumpkinTNT(world, x, y, z, ignitor);
	}
}