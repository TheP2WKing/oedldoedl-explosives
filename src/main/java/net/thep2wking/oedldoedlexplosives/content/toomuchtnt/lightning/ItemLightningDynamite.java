...
public class ItemLightningDynamite extends ModItemDynamiteBase {
	public ItemLightningDynamite(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
	...
	public ModEntityDynamiteBase createDynamiteEntity(World world) {
		return new EntityLightningDynamate(world);
	}

	@Override
	public ModEntityDynamiteBase createDynamiteEntity(World world, EntityLivingBase entity) {
		return new EntityLightningDynamate(world, entity);
	}
}