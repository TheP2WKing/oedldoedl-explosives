...
public class EntityGrenadeApple extends EntityThrowable {
	public EntityGrenadeApple(World worldIn) {
		super(worldIn);
	}

	public EntityGrenadeApple(World worldIn, EntityLivingBase throwerIn) {
		super(worldIn, throwerIn);
	}

	public EntityGrenadeApple(World worldIn, double x, double y, double z) {
		super(worldIn, x, y, z);
	}

	public static void registerFixesSnowball(DataFixer fixer) {
		EntityThrowable.registerFixesThrowable(fixer, "EntityGrenadeApple");
	}
