		...
		for (int r = radius, x5 = -r; x5 < r; ++x5) {
			for (int y5 = r; y5 > -r; --y5) {
				for (int z6 = -r; z6 < r; ++z6) {
					if (this.world.getBlockState(new BlockPos((int) this.posX + x5, (int) this.posY + y5 - 1, (int) this.posZ + z6)) == Blocks.GRASS.getDefaultState() && this.world.getBlockState(new BlockPos((int) this.posX + x5, (int) this.posY + y5, (int) this.posZ + z6)) == Blocks.AIR.getDefaultState() || this.world.getBlockState(new BlockPos((int) this.posX + x5, (int) this.posY + y5 - 1, (int) this.posZ + z6)) == Blocks.DIRT.getDefaultState() && this.world.getBlockState(new BlockPos((int) this.posX + x5, (int) this.posY + y5, (int) this.posZ + z6)) == Blocks.AIR.getDefaultState()) {
