...
public class BlockSupersonicTNT extends ModBlockTNTBase {
	public BlockSupersonicTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntitySupersonicTNT(world, x, y, z, ignitor);
	}
}