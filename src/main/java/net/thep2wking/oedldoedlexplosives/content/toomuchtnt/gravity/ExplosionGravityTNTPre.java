...
public class ExplosionGravityTNTPre extends ModExplosionBase {
	public ExplosionGravityTNTPre(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
