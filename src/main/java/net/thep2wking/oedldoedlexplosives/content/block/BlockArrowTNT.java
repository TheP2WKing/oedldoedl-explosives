...
public class BlockArrowTNT extends ModBlockTNTBase {
	public BlockArrowTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityArrowTNT(world, x, y, z, ignitor);
	}
}