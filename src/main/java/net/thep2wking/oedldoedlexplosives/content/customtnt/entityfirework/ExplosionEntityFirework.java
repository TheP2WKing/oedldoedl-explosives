...
public class ExplosionEntityFirework extends ModExplosionBase {
	public ExplosionEntityFirework(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
