...
public class BlockCombatTNT extends ModBlockTNTBase {
	public BlockCombatTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityCombatTNT(world, x, y, z, ignitor, 80, 16.0f, false, false);
	}
}