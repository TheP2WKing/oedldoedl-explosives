...
public class ExplosionGravelFirework extends ModExplosionBase {
	public ExplosionGravelFirework(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
