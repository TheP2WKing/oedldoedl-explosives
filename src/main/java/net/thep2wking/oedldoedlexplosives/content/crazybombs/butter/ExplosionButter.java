...
public class ExplosionButter extends ModExplosionBase {
	public ExplosionButter(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
		...
		if (this.spawnFire) {
			for (BlockPos blockpos1 : this.affectedBlockPositions) {
				...
				if (this.world.getBlockState(blockpos1).getMaterial() == Material.AIR
					...
					this.world.setBlockState(blockpos1, Blocks.GOLD_BLOCK.getDefaultState(), 3);
				}
			}
		}
	}
