...
public class ItemTheP2WKingDynamite extends ModItemDynamiteBase {
	...
	public ModEntityDynamiteBase createDynamiteEntity(World world) {
		return new EntityTheP2WKingDynamite(world);
	}

	@Override
	public ModEntityDynamiteBase createDynamiteEntity(World world, EntityLivingBase entity) {
		return new EntityTheP2WKingDynamite(world, entity);
	}
}