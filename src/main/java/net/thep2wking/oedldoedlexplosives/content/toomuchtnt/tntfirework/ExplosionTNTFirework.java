...
public class ExplosionTNTFirework extends ModExplosionBase {
	public ExplosionTNTFirework(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
