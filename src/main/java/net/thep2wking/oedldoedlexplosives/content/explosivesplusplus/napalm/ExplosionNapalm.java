...
public class ExplosionNapalm extends ModExplosionBase {
	public ExplosionNapalm(World worldIn, Entity ignitor, double x, double y, double z, float explosionStrength,
		...
		if (this.spawnFire) {
			for (BlockPos blockpos1 : this.affectedBlockPositions) {
				...
				if ((blockState.getMaterial() == Material.AIR
					...
					this.world.setBlockState(blockpos1, Blocks.LAVA.getDefaultState());
				}
			}
		}
	}
