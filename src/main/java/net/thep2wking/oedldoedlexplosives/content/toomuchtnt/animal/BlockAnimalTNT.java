...
public class BlockAnimalTNT extends ModBlockTNTBase {
	public BlockAnimalTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityAnimalTNT(world, x, y, z, ignitor);
	}
}