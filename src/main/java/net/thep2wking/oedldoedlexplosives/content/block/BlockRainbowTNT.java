...
public class BlockRainbowTNT extends ModBlockTNTBase {
	public BlockRainbowTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
