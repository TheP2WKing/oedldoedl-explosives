...
public class BlockDayTNT extends ModBlockTNTBase {
	public BlockDayTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityDayTNT(world, x, y, z, ignitor);
	}
}