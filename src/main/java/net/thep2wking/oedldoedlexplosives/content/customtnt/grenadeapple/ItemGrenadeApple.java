...
public class ItemGrenadeApple extends ModItemDynamiteBase {
	public ItemGrenadeApple(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
