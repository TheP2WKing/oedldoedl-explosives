...
public class BlockEggTNT extends ModBlockTNTBase {
	public BlockEggTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityEggTNT(world, x, y, z, ignitor);
	}
}