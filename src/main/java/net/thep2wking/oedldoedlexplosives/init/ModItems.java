...
import net.thep2wking.oedldoedlexplosives.content.item.ItemAnimalDynamite;
import net.thep2wking.oedldoedlexplosives.content.item.ItemCombatDynamite;
import net.thep2wking.oedldoedlexplosives.content.item.ItemCubicDynamite;
...
public class ModItems {
	...
	public static final Item DRILL_TNT = new ModItemBlockBase(ModBlocks.DRILL_TNT, ModRarities.YELLOW, false, 1, 0);
	public static final Item FLAT_TNT = new ModItemBlockBase(ModBlocks.FLAT_TNT, ModRarities.YELLOW, false, 1, 0);
	...
	public static final Item SNOW_TNT = new ModItemBlockBase(ModBlocks.SNOW_TNT, ModRarities.WHITE, false, 1, 0);
	public static final Item BUNDLED_TNT = new ModItemBlockBase(ModBlocks.BUNDLED_TNT, ModRarities.WHITE, false, 1, 0);
	public static final Item SUPERSONIC_TNT = new ModItemBlockBase(ModBlocks.SUPERSONIC_TNT, ModRarities.YELLOW, false, 1, 0);
	public static final Item RAINBOW_TNT = new ModItemBlockBase(ModBlocks.RAINBOW_TNT, ModRarities.WHITE, false, 1, 0);
	...
	public static final Item NUKE_NC = new ModItemBlockBase(ModBlocks.NUKE_NC, ModRarities.RED, false, 1, 0);
