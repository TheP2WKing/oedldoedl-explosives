...
public class BlockDetonatorChainTNT extends ModBlockTNTBase {
	public BlockDetonatorChainTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor, int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityDetonatorChainTNT(world, x, y, z, ignitor, 1, 1.0f, false, true);
	}
