...
public class ItemDiggingDynamite extends ModItemDynamiteBase {
	public ItemDiggingDynamite(String modid, String name, CreativeTabs tab, EnumRarity rarity, boolean hasEffect,
