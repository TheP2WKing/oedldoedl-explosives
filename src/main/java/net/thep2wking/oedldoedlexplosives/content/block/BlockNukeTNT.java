...
public class BlockNukeTNT extends ModBlockTNTBase {
	public BlockNukeTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor, int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityNukeTNT(world, x, y, z, ignitor, 220, 8.0f, false, true);
	}
}