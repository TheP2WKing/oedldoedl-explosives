...
public class BlockGravityTNT extends ModBlockTNTBase {
	public BlockGravityTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityGravityTNT(world, x, y, z, ignitor);
	}
}