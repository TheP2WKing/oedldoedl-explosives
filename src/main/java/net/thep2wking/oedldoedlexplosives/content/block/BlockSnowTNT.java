...
public class BlockSnowTNT extends ModBlockTNTBase {
	public BlockSnowTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntitySnowTNT(world, x, y, z, ignitor);
	}
}