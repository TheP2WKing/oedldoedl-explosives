...
public class BlockCubicTNT extends ModBlockTNTBase {
	public BlockCubicTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityCubicTNT(world, x, y, z, ignitor);
	}
}