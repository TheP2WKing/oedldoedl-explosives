...
public class BlockSirDerpingtonTNT extends ModBlockTNTBase {
	public BlockSirDerpingtonTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntitySirDerpingtonTNT(world, x, y, z, ignitor);
	}
}