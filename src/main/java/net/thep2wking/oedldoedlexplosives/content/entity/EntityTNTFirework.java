...
public class EntityTNTFirework extends ModEntityTNTBase {
	...
	public void spawnFireworkBlock() {
		if (!this.world.isRemote) {
			EntityTNTFireworkCustomTNT entitytntprimed = new EntityTNTFireworkCustomTNT(this.world,
					(float) this.posX + 0.5f, (float) this.posY + 0.5f, (float) this.posZ + 0.5f, ignitor, 500, 4.0f,
					false, true);
