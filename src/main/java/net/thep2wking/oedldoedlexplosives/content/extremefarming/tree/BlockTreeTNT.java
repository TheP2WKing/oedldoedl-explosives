...
public class BlockTreeTNT extends ModBlockTNTBase {
	public BlockTreeTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityTreeTNT(world, x, y, z, ignitor);
	}
}