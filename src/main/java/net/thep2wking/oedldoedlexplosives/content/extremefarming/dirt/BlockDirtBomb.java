...
public class BlockDirtBomb extends ModBlockTNTBase {
	public BlockDirtBomb(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,
			int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityDirtBomb(world, x, y, z, ignitor);
	}
}