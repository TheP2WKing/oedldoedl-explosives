...
public class BlockRandomBlocksTNT extends ModBlockTNTBase {
	public BlockRandomBlocksTNT(String modid, String name, CreativeTabs tab, SoundType sound, MapColor mapColor,int lightLevel) {
	...
	public ModEntityTNTBase createTNTEntity(World world, double x, double y, double z, EntityLivingBase ignitor) {
		return new EntityRandomBlocksTNT(world, x, y, z, ignitor);
	}
}