...
public class ModSandRenderer extends Render<ModEntityTNTBase> {
	public final Block block;

	public ModSandRenderer(RenderManager renderManagerIn, Block block) {
	...
	public static void register(Class<? extends Entity> tntEntityClass, Block tntBlock) {
		RenderingRegistry.registerEntityRenderingHandler(tntEntityClass,
				new ModSandRenderer(Minecraft.getMinecraft().getRenderManager(), tntBlock));
	}
}