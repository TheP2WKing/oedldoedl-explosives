...
public class EntityAnimalTNT extends ModEntityTNTBase {
	public EntityAnimalTNT(World world, double x, double y, double z, EntityLivingBase igniter, int fuse,
	...
	public ModExplosionBase createTNTExplosion(double x, double y, double z) {
		return new ExplosionAnimalTNT(world, ignitor, x, y, z, 10.0f, false, false, false, 64);
	}
}